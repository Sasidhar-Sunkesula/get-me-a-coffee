...
const NavBar = () => {
  ...
  return (
    <nav className="bg-black text-white flex justify-between gap-4 px-4 items-center md:h-16 flex-col md:flex-row">
      ...
      >
        <span className="text-2xl md:text-base my-3 md:my-0">
          GetMeACoffee!
        </span>
      </Link>
      <div
        className="relative flex flex-col gap-4 md:block"
  ...
  focus:ring-blue-300 md:w-20 w-24 m-auto  dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5
