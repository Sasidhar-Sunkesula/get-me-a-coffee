...
const Login = () => {
  ...
  return (
    <div className="text-white py-14 container mx-auto">
      ...
      <div className="flex flex-col min-h-screen items-center mt-4 gap-4 p-10">
        <button className="flex w-64 items-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 hover:text-black  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
        ...
        <button className="flex w-64 items-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:text-black  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <button className="flex w-64 items-center border hover:text-black  border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <button
          ...
          className="flex w-64 items-center border hover:text-black  border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        >
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
